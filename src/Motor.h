...
#define SERVO_DOOR_BACK_UP 255
#define SERVO_DOOR_BACK_DOWN 125
#define SERVO_DOOR_FRONT_UP 255
#define SERVO_DOOR_FRONT_DOWN 60    // TODO: Might be to low and hitting the ground
