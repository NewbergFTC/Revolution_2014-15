...
#define CONTROLLER_BUTTON_LEFT_TRIGGER   	6
#define CONTROLLER_BUTTON_LEFT_BUMPPER   	4
#define CONTROLLER_BUTTON_RIGHT_TRIGGER  	7
#define CONTROLLER_BUTTON_RIGHT_BUMPPER  	5
